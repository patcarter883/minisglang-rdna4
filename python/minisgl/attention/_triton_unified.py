...
# Local copy of the upstream KVQuantMode enum. The kernel branches on the
# INTEGER values as constexpr, so the member values must match upstream exactly.
...
is_batch_invariant = False  # RDNA4: was envs.VLLM_BATCH_INVARIANT
float8_info = torch.finfo(torch.float8_e4m3fn)  # RDNA4: fp8 dtype literal
...
def unified_attention(
    ...
    kernel_unified_attention[grid](
        ...
        Q_IS_FP8=(q.dtype == torch.float8_e4m3fn),  # RDNA4: fp8 dtype literal
